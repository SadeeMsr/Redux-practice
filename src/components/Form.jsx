...
export default function Form() {
  ...
  const [AuthorFirstName, setAuthorFirstName] = useState(dataForEdit.AuthorFirstName || "");
  const [AuthorLastName, setAuthorLastName] = useState(dataForEdit.AuthorLastName || "");
  const [EditorFirstName, setEditorFirstName] = useState(dataForEdit.EditorFirstName || "");
  const [EditorLastName, setEditorLastName] = useState(dataForEdit.EditorLastName || "");
  const [title, setTitle] = useState(dataForEdit? dataForEdit.title:"");
  const [categories, setSelectedCategories] = useState(dataForEdit.categories || []);
  ...
  function handleSubmit(e) {
    ...
    formType === "Create" ? dispatch(createBook(formattedData)) : dispatch(updateBook(formattedData))
  }
